...
<body>
	...
	<div class="headerbg">
	 <div class="col-md-12" align="center"><h1>{{ __('user.shop') }}</h1></div>
	 </div>
	<div class="">
    ...
    <ul class="nav nav-tabs" id="myTab">
      <li class="active"><a href="#inbox" data-toggle="tab"><span class="lnr lnr-user blok"></span> {{ __('user.profile') }}</a></li>
      <li><a href="#sent" data-toggle="tab"><span class="lnr lnr-cog blok"></span> {{ __('user.services') }}</a></li>
	...
	<div class="form-group">
		...
		<div class="col-md-12">
			<div>
					<a href="<?php echo $url;?>/editshop/<?php echo $shop[0]->id;?>" class="btn btn-success btn-md radiusoff">{{ __('user.edit_shop') }}</a>
					<a href="<?php echo $url;?>/services" class="btn btn-danger btn-md radiusoff">{{ __('user.edit_services') }}</a>					
				</div>
			</div>	
