...
<div class="col-md-4">
<h5><strong>{{ __('user.choose_service') }} <span class="require">*</span></strong></h5>
<?php 
...
<h5><strong>{{ __('user.select_date') }}<span class="require">*</span></strong></h5>
...
<br/>
<h5><strong>{{ __('user.address') }} <span class="require">*</span></strong></h5>
...
<h5><strong>{{ __('user.select_time') }} <span class="require">*</span></strong></h5>
...
<br/>
<h5><strong>{{ __('user.city') }} <span class="require">*</span></strong></h5>
<input type="text" class="form-control validate[required]" id="book_city" name="book_city" > 

</div>

<div class="col-md-4">
<h5><strong>{{ __('user.payment_mode') }} <span class="require">*</span></strong></h5>
...
<br/>
<h5><strong>{{ __('user.pincode') }} <span class="require">*</span></strong></h5>
...
<div class="col-md-12">
<h5><strong>{{ __('user.note') }} </strong></h5>
...
<div class="container">
<h3 class="left">{{ __('user.create_new_account') }}</h3>
<br/>
<div class="form-group col-md-3">
<label>{{ __('user.username') }} <span class="require">*</span></label>
...
<div class="form-group col-md-3">
<label>{{ __('user.email') }} <span class="require">*</span></label>
...
<div class="form-group col-md-3">
<label>{{ __('user.phone_no') }}<span class="require">*</span></label>
 <input id="phoneno" type="text" class="form-control validate[required]" name="phoneno">
</div>

<div class="form-group col-md-3">
<label>{{ __('user.password') }} <span class="require">*</span></label>
...
<div class="form-group col-md-3">
<label>{{ __('user.gender') }} <span class="require">*</span></label>
...
<div class="form-group col-md-3">
<label>{{ __('user.user_type') }} <span class="require">*</span></label>
...
<div class="container">
<div class="col-md-2">
<input type="submit"  value="{{ __('user.submit') }}" name="submit" class="booknow right">
</div>
</div>
</form>
