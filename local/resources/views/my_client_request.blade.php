...
<body>
	...
	<div class="headerbg">
	 <div class="col-md-12" align="center"><h1>{{ __('user.running_job_client') }}</h1></div>
	 </div>
	<div class="container">
	...
	<td><input type="button" name="status" value="<?php echo $status_payment;?>" class="<?php echo $btn_cls;?> sv_track_btn" style="cursor:default;">
	
	<a href="<?php echo $url;?>/buyer_track/<?php echo $giv->id;?>" class="btn btn-success">{{ __('user.track_request') }} </a>
