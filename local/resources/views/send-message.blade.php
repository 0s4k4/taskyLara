...
<body>
	...
	<div class="video">
	<div class="headerbg">
	 <div class="col-md-12" align="center"><h1>{{ __('user.send_message') }}</h1></div>
	 </div>
	<div class="container">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('send-message') }}" id="formID" enctype="multipart/form-data">
                        {{ csrf_field() }}
						 ...
						 <div class="form-group">
                            <label for="name" class="col-md-4 control-label">{{ __('user.to') }} </label>
                        ...
                        <div class="form-group">
                            <label for="name" class="col-md-4 control-label">{{ __('user.your_message') }} </label>
