...
<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
		...
		<li><a href="<?php echo $url;?>/about">{{ __('user.about') }} </a></li>
		<li><a href="<?php echo $url;?>/terms-conditions">{{ __('user.terms_conditions') }}</a></li>
		<li><a href="<?php echo $url;?>/privacy-policy">{{ __('user.privacy_policy') }}</a></li>
		<li><a href="<?php echo $url;?>/blog">{{ __('user.blog') }}</a></li>
		...
		<h4>{{ __('user.customers') }} </h4>
		<ul>
		<li><a href="<?php echo $url;?>/how-it-works">{{ __('user.how_works') }}</a></li>
		<li><a href="<?php echo $url;?>/safety">{{ __('user.safety') }} </a></li>
		<li><a href="<?php echo $url;?>/service-guide">{{ __('user.service_guide') }}</a></li>
		<li><a href="<?php echo $url;?>/how-to-pages">{{ __('user.how_pages') }}</a></li>
		</ul>
		</div>
		...
		<li><a href="<?php echo $url;?>/success-stories">{{ __('user.success_stories') }}</a></li>
		</ul>
		</div>
	  ...
	  <p><?php if($setts[0]->site_copyright!=""){?><?php echo $setts[0]->site_copyright; } else {?>&copy; <?php echo date('Y');?>. {{ __('user.all_rights_reserved') }} Migrateshop<?php } ?></p>
	  </div>
