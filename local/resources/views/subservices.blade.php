...
<body>
 <?php $url = URL::to("/"); ?> 
	...
	<div class="clearfix sv_mob_clearfix"></div>
	<div class="headerbg">
	 <div class="col-md-12" align="center"><h1><?php if(!empty($service_id[0]->name)){?><?php echo $service_id[0]->name; ?><?php } else { ?>{{ __('user.services') }}<?php } ?></h1></div>
	 </div>
   ...
   <div class="col-md-12 noservice" align="center">{{ __('user.services_found') }}</div>
