...
?>
	...
	<div class="clearfix sv_mob_clearfix"></div>
	<div class="headerbg">
	 <div class="col-md-12" align="center"><h1>{{ __('user.payment_confirmation') }}</h1></div>
	 </div>
	...
	<label>{{ __('user.services_name') }} </label> - <?php echo $service_names; ?><br>
     <label>{{ __('user.booking_date') }}</label> -  <?php echo $booking_date; ?><br>
    <label>{{ __('user.price') }}</label> - <?php echo $prices; ?> <?php echo $currency; ?>
   ...
   <input type="hidden" name="item_name" value="<?php echo $service_names; ?>">
        ...
        <input type="submit" name="submit" value="{{ __('user.paynow') }}" class="paynow radiusoff">
