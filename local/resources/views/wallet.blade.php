...
<body>
	...
	<div class="headerbg">
	 <div class="col-md-12" align="center"><h1>{{ __('user.wallet') }}</h1></div>
	 </div>
...
<div class="container">
	...
	<div class="text-center withdraw_amt">		
		<span class="lnr lnr-tag"></span> <label>&nbsp;{{ __('user.minimum_withdraw_amt') }}</label><span>&nbsp;<?php echo $setting[0]->withdraw_amt;?> <?php echo $setting[0]->site_currency;?>	</span>			
	</div>
     <br/>
	<div class="col-md-12">
	...
	<input type="hidden" name="min_with_amt" value="<?php echo $setting[0]->withdraw_amt;?>">
		...
		<div class="col-sm-2">
			<div class="form-group">
				<label>{{ __('user.shop_balance') }}</label> [ <?php echo $setting[0]->site_currency;?> ]
				<?php 
		...
		<div class="col-sm-2">
			<div class="form-group">
				<label>{{ __('user.withdraw_amount') }}</label>
		...
		<div class="col-sm-4">
			<div class="form-group">
				<label>{{ __('user.withdraw_option') }}</label>
		...
		<div class="col-sm-4" id="paypal" style="display:none;">
			<div class="form-group">
				<label>{{ __('user.enter_paypal_id') }}</label>
		...
		<div class="col-sm-4" id="stripe" style="display:none;">
			<div class="form-group">
				<label>{{ __('user.enter_stripe_email_id') }}</label>
		...
		<div class="col-sm-4" id="payumoney" style="display:none;">
			<div class="form-group">
				<label>{{ __('user.enter_payumoney_email_id') }}</label>
	...
	<?php if(config('global.demosite')=="yes"){?><button type="button" class="form-control services-btn radiusoff btndisable">{{ __('user.save') }}</button> 
								<span class="disabletxt">( <?php echo config('global.demotxt');?> )</span><?php } else { ?>
	
	
			<input type="submit" class="form-control services-btn radiusoff" name="save" value="{{ __('user.save') }}">
								<?php } ?>
	</div>
	</div>
	...
	<?php 
	 ...
	 <div class="err-msg" align="center">{{ __('user.your_balance') }} <?php echo $check_count;?> <?php echo $setting[0]->site_currency;?></div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                             <th>{{ __('user.sno') }}</th>
											<th>{{ __('user.withdraw_amount') }}</th>
											<th>{{ __('user.withdraw_mode') }}</th>
											<th>{{ __('user.paypal_id') }}</th>
											<th>{{ __('user.stripe_id') }}</th>
											<th>{{ __('user.payumoney_id') }}</th>
											<th>{{ __('user.bank_account_no') }}</th>
											<th>{{ __('user.bank_info') }}</th>
											<th>{{ __('user.ifsc_code') }}</th>
