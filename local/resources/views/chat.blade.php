...
<body>
  ...
  {	  
	...
	<div class="headerbg">
	 <div class="col-md-12" align="center"><h2>{{ __('user.conversation_with') }} <span class="black"><?php if($type=="2"){ ?><a href="<?php echo $pather;?>" class="black <?php echo $class;?>"><?php echo $usernamo;?></a> <?php }else{ echo $usernamo; } ?></span></h2></div>
	 </div>
	<div class="container">
...
<div class="container">
	...
	<div class="form-group card required">
                  <label class="control-label">{{ __('user.message') }}</label>
	...
	<div class="form-group card required">
	<a href="<?php echo $url;?>/messages" class="btn btn-primary"> {{ __('user.back') }} </a>
