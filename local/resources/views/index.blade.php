...
/* document.getElementById("search_text").onchange = function() {
	...
	<div class="works">
	<div class="container">
	 <div class="col-md-12" align="center"><h1> {{ __('user.how_works') }}</h1></div>
	<div class="row">
	<div class="col-md-12">
	...
	<div class="media">
	  ...
	  <div class="media-body">
		...
		<h4 class="media-heading"> {{ __('user.describe_task') }}</h4>
	...
	<div class="media">
	  ...
	  <div class="media-body">
		...
		<h4 class="media-heading"> {{ __('user.get_matched') }}</h4>
	...
	<div class="media">
	  ...
	  <div class="media-body">
		...
		<h4 class="media-heading"> {{ __('user.get_done') }}</h4>
