...
<body>
	...
	<div class="headerbg">
	 <div class="col-md-12" align="center"><h1><?php echo e(__('user.job_freelancer')); ?></h1></div>
	 </div>
	...
	<div class="col-md-12  text-left">
	  ...
	  <table id="mytable" class="table table-striped table-bordered table-hover datatable">
                  ...
                  <th><?php echo e(__('user.reference_id')); ?></th>
                    <th><?php echo e(__('user.orders')); ?> </th>
                     <th><?php echo e(__('user.order_date')); ?></th>
                     <th><?php echo e(__('user.expiry_date')); ?></th>
...
$end_last = date('Y-m-d', $new_date);		
	...
	<a href="<?php echo $url;?>/seller_track/<?php echo $giv->id;?>" class="btn btn-success"><?php echo e(__('user.track_request')); ?></a>
	...
	<div><?php echo e(__('user.note_funded_projects_display')); ?></div>
...
</html><?php /**PATH C:\xampp\htdocs\venkat\tasky\tasky\local\resources\views/my_freelancer_request.blade.php ENDPATH**/ ?>