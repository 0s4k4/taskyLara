...
<body>
	...
	<div class="headerbg">
	 <div class="col-md-12" align="center"><h1><?php echo e(__('user.booking_details')); ?></h1></div>
	 </div>
	...
	<div class="col-md-6">
		<h4><?php echo $shop[0]->shop_name;?></h4>
			...
			<p><i class="fa fa-calendar-o" aria-hidden="true"></i> <?php echo e(__('user.booking_date')); ?>- <?php echo $booking[0]->booking_date; ?></p>
			<p> <i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo e(__('user.booking_time')); ?> - <?php echo $final_time; ?></p>
	...
	<div class="col-md-6 service_style">
	 ...
	 <table class="table table-striped table-bordered table-hover" id="dataTables-example">
            <thead>
                <tr>
                    <th><?php echo e(__('user.selected_services')); ?></th>
					<th><?php echo e(__('user.price')); ?></th>
					 <th><?php echo e(__('user.service_charge')); ?></th>
					 <th><?php echo e(__('user.tax')); ?></th>
                </tr>
            </thead>
			<tbody>			
			<tr>
...
?>
			...
			<td class="total-charge" colspan="1"><?php echo e(__('user.total_charges_c')); ?></td><td class="total-charge"><?php echo $total_sum;?>&nbsp;<?php echo $currency;?></td>
			</tbody>
	...
	// echo $enc;
	?>
	<form class="" name="admin_s" id="formID" method="post" enctype="multipart/form-data" action="<?php echo e(route('booking_info')); ?>">
	<?php echo csrf_field(); ?>
...
<button type="submit" value="PROCEED TO CHECKOUT" class="booknow right"><?php echo e(__('user.proceed_checkout_c')); ?></button>
...
</html><?php /**PATH C:\xampp\htdocs\venkat\tasky\tasky\local\resources\views/booking_info.blade.php ENDPATH**/ ?>