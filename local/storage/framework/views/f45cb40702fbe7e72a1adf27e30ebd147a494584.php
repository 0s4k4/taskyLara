...
<body>
	...
	<div class="headerbg">
	 <div class="col-md-12" align="center"><h1><?php echo e(__('user.all_jobs')); ?></h1></div>
	 </div>
	<div class="container">
	<div class="clearfix height30"></div>
	 <div class="col-md-12">
	  
	  <form role="form" method="POST" action="<?php echo e(route('buyer_request')); ?>" id="formID" enctype="multipart/form-data">
     ...
     <h3 class="sv_title"><?php echo e(__('user.category')); ?></h3>	  
	  <select name="everyone" class="pads10" onChange="window.document.location.href=this.options[this.selectedIndex].value;">	

			  <option value=""><?php echo e(__('user.category')); ?></option>
			  <option value="<?php echo $url;?>/buyer_request"><?php echo e(__('user.all')); ?></option>
	...
	<div class="col-md-3">
	<h3 class="sv_title"><?php echo e(__('user.skills')); ?></h3>	
...
<?php /* ?>
	...
	<h3 class="sv_title"><?php echo e(__('user.price_range')); ?></h3>	
<input type="text" id="amount" name="price_range" readonly >
	...
	<div class="col-md-3">
		...
		<h3 class="sv_title"><?php echo e(__('user.preferred_location')); ?></h3>	
	...
	<div class="col-md-3">
	<div></div>
	<h3 class="sv_title"><?php echo e(__('user.featured')); ?> </h3>
	...
	<div class="table-responsive col-md-12 service_style">
	  ...
	  <table id="mytable" class="table table-striped table-bordered table-hover datatable">
                   ...
                   <th><?php echo e(__('user.image_c')); ?></th>
                    <th><?php echo e(__('user.request')); ?></th>
                     <th><?php echo e(__('user.bids_c')); ?></th>
                     <th><?php echo e(__('user.delivery')); ?> </th>
                       <th><?php echo e(__('user.budget_c')); ?></th>
					   <th> <?php echo e(__('user.request_owner')); ?></th>
					   <th><?php echo e(__('user.bid_now')); ?> </th>
					   </tr>
                   </thead>
			...
			<?php } ?>
			<?php if($request->featured==1){?><div class="feature_job"><span class="featured"><?php echo e(__('user.featured')); ?></span></div><?php } ?>
			</td>
			...
			<td>
			<?php if (Auth::guest()) {?>
			<a href="javascript:void(0);" class="btn btn-success" onclick="alert('Login user only');"><?php echo e(__('user.send_offer')); ?></a>
			<?php } else { 
			
			if(Auth::user()->id == $request->user_id)
			{
			?>
			<a href="<?php echo $url;?>/request/<?php echo $request->gid;?>/<?php echo $request->request_slug;?>" class="btn btn-success"><?php echo e(__('user.view_project')); ?> </a>
			<?php } else { 
			...
			?>
			<a href="<?php echo $url;?>/request/<?php echo $request->gid;?>/<?php echo $request->request_slug;?>" class="btn btn-info"><?php echo e(__('user.awarded_you')); ?></a>
			
			<?php } else if($award_check[0]->prop_user_id!=Auth::user()->id) {?>
			
			<a href="<?php echo $url;?>/request/<?php echo $request->gid;?>/<?php echo $request->request_slug;?>" class="btn btn-danger"><?php echo e(__('user.awarded_other')); ?></a>
            ...
            <a href="javascript:void(0);" onclick="alert('Your e-mail address must be confirmed before you can buy the request');" class="btn btn-success"><?php echo e(__('user.bid_now')); ?></a>
			<?php } else { ?>

          <a href="<?php echo $url;?>/request/<?php echo $request->gid;?>/<?php echo $request->request_slug;?>" class="btn btn-success"><?php echo e(__('user.bid_now')); ?></a>
...
<?php /**PATH C:\xampp\htdocs\venkat\tasky\tasky\local\resources\views/buyer_request.blade.php ENDPATH**/ ?>