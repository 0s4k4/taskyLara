...
<body class="<?php echo e($view_name); ?>">
	...
	<div class="bannertxt">
		...
		<div class="row">
		<div class="col-md-12">
		<h4 class="colorCabecera"> <?php echo e(__('user.taskers_help_without_breaking_bank')); ?> </h4>
		</div>
...
/* document.getElementById("search_text").onchange = function() {
	...
	<div class="works">
	<div class="container">
	 <div class="col-md-12" align="center"><h1> <?php echo e(__('user.how_works')); ?></h1></div>
	<div class="row">
	<div class="col-md-12">
	...
	<div class="media">
	  ...
	  <div class="media-body">
		...
		<h4 class="media-heading"> <?php echo e(__('user.describe_task')); ?></h4>
	...
	<div class="media">
	  ...
	  <div class="media-body">
		...
		<h4 class="media-heading"> <?php echo e(__('user.get_matched')); ?></h4>
	...
	<div class="media">
	  ...
	  <div class="media-body">
		...
		<h4 class="media-heading"> <?php echo e(__('user.get_done')); ?></h4>
...
</html><?php /**PATH C:\xampp\htdocs\venkat\tasky\tasky\local\resources\views/index.blade.php ENDPATH**/ ?>