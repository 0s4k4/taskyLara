...
<html lang="es">
  ...
  <body class="nav-md">
	...
	<?php endif; ?>
                   ...
                   <form class="form-horizontal form-label-left" role="form" method="POST" action="<?php echo e(route('admin.editsubservice')); ?>" enctype="multipart/form-data" novalidate>
...
<?php /**PATH C:\xampp\htdocs\taskyLara\local\resources\views/admin/editsubservice.blade.php ENDPATH**/ ?>