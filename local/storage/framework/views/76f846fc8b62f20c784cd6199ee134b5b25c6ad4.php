					  ...
					  ?>
                        ...
                        <tr>
						 <td><?php echo $i;?></td>
						  ...
						  <td>
						 <a href="<?php echo $url;?>/admin/view_request/<?php echo e($gig->gid); ?>" class="btn btn-success">View More</a>
						 </td>
						  ...
						  <?php } else {?> <a href="<?php echo $url;?>/admin/request/status/1/<?php echo e($gig->gid); ?>" class="btn btn-success">Activate</a> 
						  <?php } ?>
						  
						  
						  <?php if(config('global.demosite')=="yes"){?>
						  <a href="#" class="btn btn-success btndisable">Deactivate</a>  <span class="disabletxt">( <?php echo config('global.demotxt');?> )</span>
						  <?php } else {?> <a href="<?php echo $url;?>/admin/request/status/0/<?php echo e($gig->gid); ?>" class="btn btn-success">Deactivate</a>
						  <?php } ?>
...
<?php /**PATH C:\xampp\htdocs\venkat\tasky\tasky\local\resources\views/admin/request.blade.php ENDPATH**/ ?>