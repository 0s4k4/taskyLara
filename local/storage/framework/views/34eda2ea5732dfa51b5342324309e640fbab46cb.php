...
<html lang="es">
  ...
  <body class="nav-md">
	...
	<?php endif; ?>
                <?php $url = URL::to("/"); ?>    
                   <form class="form-horizontal form-label-left" role="form" method="POST" action="<?php echo e(route('admin.settings')); ?>" enctype="multipart/form-data" novalidate>
		...
		<div class="item form-group">
					  ...
					  <img src="<?php echo $url.'/local/images/noimage.jpg';?>" class="logo" width="100">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="file" id="site_favicon" name="site_favicon" class="form-control col-md-7 col-xs-12">
						   <?php if($errors->has('site_favicon')): ?>
                                    <span class="help-block" style="color:red;">
                                        <strong><?php echo e($errors->first('site_favicon')); ?></strong>
                                    </span>
                                <?php endif; ?>
					  ...
					  <img src="<?php echo $url.'/local/images/noimage.jpg';?>" class="logo" width="24" style="border:1px solid #CCCCCC;">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="file" id="site_banner" name="site_banner" class="form-control col-md-7 col-xs-12">
						   <?php if($errors->has('site_banner')): ?>
                                    <span class="help-block" style="color:red;">
                                        <strong><?php echo e($errors->first('site_banner')); ?></strong>
                                    </span>
                                <?php endif; ?>
                    ...
                    <div class="item form-group">
					  ...
					  <div class="item form-group">
					    ...
					    <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Google Map Key <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="google_map_key" class="form-control col-md-7 col-xs-12"  name="google_map_key" value="<?php echo $settings[0]->google_map_key; ?>" required="required" type="text">
                        
					   </div>
                      </div>
					  	<div class="item form-group">
						    <label for="site_address" class="control-label col-md-3 col-sm-3 col-xs-12" >Site Address <span class="required">*</span></label>
						    <div class="col-md-6 col-sm-6 col-xs-12">
						    	<textarea class="form-control" id="site_address" rows="3" name="site_address"><?php echo e($settings[0]->site_address); ?></textarea>
						    </div>
						</div>
...
<?php /**PATH C:\xampp\htdocs\venkat\tasky\tasky\local\resources\views/admin/settings.blade.php ENDPATH**/ ?>