...
<body>
	...
	<div class="headerbg">
	 <div class="col-md-12" align="center"><h1><?php echo e(__('user.my_applied_job')); ?></h1></div>
	 </div>
	...
	<div class="table-responsive">
	  ...
	  <table id="mytable" class="table table-striped table-bordered table-hover datatable">
                 ...
                 <th><?php echo e(__('user.bidding_date')); ?></th>
                    <th><?php echo e(__('user.job_name')); ?></th>
                     <th><?php echo e(__('user.bidding_amount')); ?></th>
                       <th><?php echo e(__('user.estimated_time_complete_c')); ?></th>
					   <th><?php echo e(__('user.message_client')); ?></th>
					   <th><?php echo e(__('user.award_status')); ?></th>
					   <th><?php echo e(__('user.client_fund_status')); ?></th>
			...
			$award_check = DB::table('request_proposal')
			   ...
			   {
			?>	   
			<span><?php echo e(__('user.job_awarded_you')); ?></span>
			   <?php } else if($award_check[0]->prop_user_id!=Auth::user()->id) { ?>	
			<span><?php echo e(__('user.awarded_other')); ?></span>
			   <?php } ?>
			
			<?php } else { ?>
			<span><?php echo e(__('user.not_yet_awarded')); ?></span>
			<?php } ?>
			</td>
...
</html><?php /**PATH C:\xampp\htdocs\venkat\tasky\tasky\local\resources\views/my_applied_request.blade.php ENDPATH**/ ?>