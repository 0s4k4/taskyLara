...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
				  ...
				  <li><a href="<?php echo $url;?>/admin/request-orders">Job Orders </a></li>
				   <li><a href="<?php echo $url;?>/admin/skills">Skills</a></li>
          ...
          <li><a href="<?php echo e(route('language.create')); ?>"><i class="fa fa-language"></i> Language </a></li>
			...
			<!--<div class="x_content">
                  ...
                  </div>--><?php /**PATH C:\xampp\htdocs\venkat\tasky\tasky\local\resources\views/admin/menu.blade.php ENDPATH**/ ?>