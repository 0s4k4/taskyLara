		 ...
		 <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
				  ...
				  <?php } else { ?>
						  ...
						  <a href="<?php echo $url;?>/admin/edit-testimonial/<?php echo e($testimonial->id); ?>" class="btn btn-success">Edit</a>
						  <?php } ?>
				   <?php if(config('global.demosite')=="yes"){?>
				    <a href="#" class="btn btn-danger btndisable">Delete</a>  <span class="disabletxt">( <?php echo config('global.demotxt');?> )</span>
				  <?php } else { ?>
						 <a href="<?php echo $url;?>/admin/testimonials/<?php echo e($testimonial->id); ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this?')">Delete</a>
						  <?php } ?>
						  </td>
                        </tr>
                        <?php $i++;} ?>
...
<?php /**PATH C:\xampp\htdocs\taskyLara\local\resources\views/admin/testimonials.blade.php ENDPATH**/ ?>