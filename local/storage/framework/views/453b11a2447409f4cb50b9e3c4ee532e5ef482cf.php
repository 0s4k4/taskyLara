        ...
        <div class="right_col" role="main">
		 ...
		 <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
				  ...
				  <?php } else { ?>		
							<a href="<?php echo $url;?>/admin/pending_withdraw/<?php echo e($draw->wid); ?>" class="btn btn-success" onclick="return confirm('Are you sure?')">Mark as Complete</a>
				  <?php } ?>
...
<?php /**PATH C:\xampp\htdocs\taskyLara\local\resources\views/admin/pending_withdraw.blade.php ENDPATH**/ ?>