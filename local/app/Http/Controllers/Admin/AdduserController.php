...
class AdduserController extends Controller
{
    ...
    protected function adduserdata(Request $request)
    {
		...
		DB::insert('insert into users (name,email,password,phone,photo,admin,gender,confirmation) values (?, ?,?, ?,?,?,?,?)', [$name,$email,$password,$phone,$namef,$admin,$gender,$confirmation]);
