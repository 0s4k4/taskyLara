...
if(!empty($data['google_map_key'])){ $google_map_key = $data['google_map_key']; } else { $google_map_key = ""; }
		...
		withdraw_amt="'.$withdraw_amt.'",withdraw_option="'.$withdraw.'",payment_option="'.$payopt.'",social_login_option="'.$sociopt.'",approve_requests="'.$approve_requests.'",min_skills="'.$min_skills.'",max_skills="'.$max_skills.'",featured_gig_price="'.$featured_gig_price.'",featured_days="'.$featured_days.'",processing_fee="'.$processing_fee.'",google_map_key="'.$google_map_key.'",site_ads_space="'.$site_ads_space.'",site_address="'.$site_address. '" where id = ?', [1]);
